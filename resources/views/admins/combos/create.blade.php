        ...
        <div class="col-md-8">
            <div class="tile">
                <form action="{{ route('admin.combos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Giá combo tự động = 0, không nhập được -->
                    <div class="mb-3">
                        <label for="price" class="form-label">Giá combo (tự động cập nhật khi thêm món)</label>
                        <input type="number" id="price" class="form-control" value="0" disabled>
